...
wget -O $TEMP_FOLDER/jaybird-4.0.6.java11.zip https://github.com/FirebirdSQL/jaybird/releases/download/v4.0.6/jaybird-4.0.6.java11.zip
...
mkdir -p $SETUP_DIR
unzip -d $SETUP_DIR/ $TEMP_FOLDER/jaybird-4.0.6.java11.zip jaybird-full-4.0.6.java11.jar
unzip -d $SETUP_DIR/ $TEMP_FOLDER/jconn3.jar.zip
unzip -d $SETUP_DIR/ $TEMP_FOLDER/sqljdbc4-3.0.jar.zip

rm $TEMP_FOLDER/jaybird-4.0.6.java11.zip
